...
import axios from "axios" // 도메인을 코드단에서 사용할 수 있게 해주는 js도구
...
// 코드단에서 "navigation"을 선언해서 넘겨주진 않았지만 <Stack.Screennavigator>에 연결 된 것만으로도 사용법 상 바로 꺼내쓰기 가능
      ...
      <View style={styles.cardContainer}>
        ...
        {Platform.OS === 'ios' ? (
          <AdMobBanner
            ...
            adUnitID="ca-app-pub-3136510936842919/3995167906"
            style={styles.banner}
          />
        ) : (
          <AdMobBanner
            bannerSize="fullBanner"
            servePersonalizedAds={true}
            adUnitID="ca-app-pub-3136510936842919/5116677882"
            style={styles.banner}
          />
        )}
      </View>
